...
public class UselessGeneration implements IWorldGenerator {
	...
	{
		generateOre(UselessBlocks.better_useless_ore, world, rnd, pos, 16, 16, 1, 4, 0, 20, BlockHelper.forBlock(Blocks.stone));
		generateOre(UselessBlocks.legitimate_diamond_ore, world, rnd, pos, 16, 16, 5, 8, 0, 255, BlockHelper.forBlock(Blocks.stone));
	}
